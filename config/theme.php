...
return [
    ...
    */
	'theme-support' => [
		...
		'genesis-menus'                   => array(
			...
			'secondary' => __( 'After Header Menu', CHILD_TEXT_DOMAIN ),
		),
    ...
    */
	'page-templates' => [
		'page-grid.php'    => __( 'Blog Grid', CHILD_TEXT_DOMAIN ),
		'page-blog.php'    => __( 'Blog Standard', CHILD_TEXT_DOMAIN ),
		'page-front.php'   => __( 'Front Page', CHILD_TEXT_DOMAIN ),
		'page-full.php'    => __( 'Full Width', CHILD_TEXT_DOMAIN ),
		'page-landing.php' => __( 'Landing Page', CHILD_TEXT_DOMAIN ),
		'page-sitemap.php' => __( 'Sitemap', CHILD_TEXT_DOMAIN ),
	],
